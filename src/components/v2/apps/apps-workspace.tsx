              ...
              <div className="grid grid-cols-2 gap-3">
                {filtered.map((s) => {
                  ...
                  return (
                    ...
                    >
                      <div className="grid h-9 w-9 place-items-center rounded-[45%] bg-brand-gradient text-primary-foreground">
  ...
  return (
    <div className="grid h-full place-items-center p-8 text-center">
      <div className="max-w-sm">
        <div className="mx-auto mb-4 grid h-14 w-14 place-items-center rounded-[45%] bg-brand-gradient text-primary-foreground shadow-elegant">
